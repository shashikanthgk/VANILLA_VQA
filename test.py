...
qst_vocab = load_str_list("datasets/1MP/vocab_questions.txt")
ans_vocab = load_str_list("datasets/1MP/vocab_answers.txt")
...
#     print(q_list)
    ...
    print(model.img_encoder.img_feature)
...
#        print(ans_vocab[indices[0].item()],probs[1].item())
